...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Admin Council</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="admin_council_form.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
    ...
    <table class="table table-striped table-bordered table-condensed" id="dataTables-example">
            ...
            while($fetch = mysqli_fetch_assoc($select))
        {
            ...
            <tr>
                ...
                <td><a href="admin_council_edit.php?id=<?php echo 
                    $fetch['id'];?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>

                <!-- <a href="delete_admin.php?id=<?php //echo $fetch['id'];?>" class="btn btn-danger delete_btn" onclick="return confirm('Are you sure you want to delete??');" ><i class="glyphicon glyphicon-trash"></i></a> -->
            ...
            <div class="modal fade" id="confirm-delete-<?php echo $fetch['id']; ?>" role="dialog">
                <div class="modal-dialog">
                    <form action="admin_council_delete.php" method="POST">
                        <!-- Modal content -->
