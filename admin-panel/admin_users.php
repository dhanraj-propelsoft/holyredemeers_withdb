...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6 showOnlyPropelAdmin" >
    ...
    <table class="table table-striped table-bordered table-condensed" id="dataTables-example">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                      <?php if($row['id'] != '1'||$_SESSION['user_id'] == '1'){
            ?>
                    <a href="edit_admin.php?admin_user_id=<?php echo $row['id']; ?>&operation=edit" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a><?php }?>
