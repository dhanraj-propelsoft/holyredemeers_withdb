...
include "connect.php";
//error_reporting(0);
//mysqli_connect("localhost","root","","holy_redeemer_admin");
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Anbiyam</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="anbiyam_form.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered table-condensed" id="dataTables-example">
            ...
            while($fetch = mysqli_fetch_assoc($select))
        {
            ...
            <tr>
                ...
                <td><a href="anbiyam_edit.php?id=<?php echo 
            ...
            <!-- Delete Confirmation Modal -->
                ...
                <div class="modal-dialog">
                    <form action="anbiyam_delete.php" method="POST">
                        <!-- Modal content -->
