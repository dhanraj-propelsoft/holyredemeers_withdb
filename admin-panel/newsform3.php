...
error_reporting(0);
include "connect.php" ;
  $select = mysqli_query($connect,"select * from news_three where status=1");
  $select2 = mysqli_query($connect,"select * from news_three where status=0");
...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">News & Events 3</h2>
	</div>
</div>
<br>
...
<form class="form" action="newsform3_edit.php" method="post"  enctype="">
	<fieldset>
			...
			<div class="col-md-5">
				...
				<div class="form-group">
					<label for="title">Title</label>
					  <input type="text" name="title_three" placeholder="title" class="form-control" required="required" >
				</div> 

				<div class="form-group">
					<label for="date">Date</label>
					<input type="date" name="date_three"  placeholder="mm/dd/yyyy" class="form-control" required="required" >
				</div>

				<div class="form-group">
					<label for="description">Description</label>
					  <textarea name="description_three" placeholder="description" class="form-control"></textarea>
				</div>
			...
			<div class="col-md-3">
				...
				<div class="form-group">				
				   ...
				   <div action="upload_three.php" class="dropzone" id="dropzoneFromtwo">

				   </div><br>				  
				   				   
				   <div align="center">
					<button type="button" class="btn btn-info" id="newsubmit-all" onclick="window.location.reload('true');"> Upload</button>
				   </div>
				</div>
	...
	<table class="table table-striped table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $fetch['title_three'];?></td>
				<td><?php echo $fetch['date_three'];?></td>
				<td><?php echo $fetch['description_three'];?></td>
				<td>
					<a href="newsform3_edit.php?id=<?php echo 
            ...
            <div class="modal fade" id="confirm-delete-<?php echo $fetch['id']; ?>" role="dialog">
                <div class="modal-dialog">
                    <form action="newsform3_delete.php" method="POST">
                        <!-- Modal content -->
     ...
     <table class="table table-striped table-bordered table-condensed">
            ...
            while($fetch1 = mysqli_fetch_assoc($select2))
        {
            ...
            <tr>
                ...
                <td><?php echo $fetch1['title_three'];?></td>
                <td><?php echo $fetch1['date_three'];?></td>
                <td><?php echo $fetch1['description_three'];?></td>
               ...
               -->
                ...
                <div class="modal-dialog">
                    <form action="newsform3_edit.php?id=<?php echo 
...
$(document).ready(function(){
 ...
 Dropzone.options.dropzoneFromtwo = {
  ...
  init: function(){
   var submitButton = document.querySelector('#newsubmit-all');
   myDropzone = this;
