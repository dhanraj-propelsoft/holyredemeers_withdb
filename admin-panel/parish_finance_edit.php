...
include "connect.php" ;
   ...
   $editid = $_REQUEST['id'];
   $select = mysqli_query($connect,"select * from parish_finance where 
   	id='$editid'");
   $fetch = mysqli_fetch_assoc($select);
	...
	$query = mysqli_query($connect,"update parish_finance set name='$name' where id ='$editid' ");	
...
<div id="page-wrapper">
	...
	<form class="form" name="finance_edit" method="post">
