...
$select = mysqli_query($connect,"select * from parish_finance");
?>
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Parish Finance Committee</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="parish_finance_form.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered table-condensed" id="dataTables-example">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="parish_finance_edit.php?id=<?php echo 
            ...
            <div class="modal fade" id="confirm-delete-<?php echo $fetch['id']; ?>" role="dialog">
                <div class="modal-dialog">
                    <form action="parish_finance_delete.php" method="POST">
                        <!-- Modal content -->
