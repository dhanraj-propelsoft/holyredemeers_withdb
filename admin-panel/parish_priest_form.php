...
<div id="page-wrapper">
	...
	<form class="form" action="parish_priest_form.php" method="post"  enctype="">
		<fieldset>
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input type="text" name=from_year placeholder="From Year" required="" class="form-control"  required="true">
				</div>

				<div class="form-group">
					<label>To Year</label>
					<input type="text" name=to_year placeholder="To Year" required="" class="form-control" >
				</div>
