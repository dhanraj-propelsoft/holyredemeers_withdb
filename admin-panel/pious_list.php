...
$select = mysqli_query($connect,"select * from pious");
?>
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Pious</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="pious_form.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered table-condensed" id="dataTables-example">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>    
                        <a href="pious_edit.php?id=<?php echo 
            ...
            <!-- Delete Confirmation Modal -->
                ...
                <div class="modal-dialog">
                    <form action="pious_delete.php" method="POST">
                        <!-- Modal content -->
