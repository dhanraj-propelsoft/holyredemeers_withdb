                ...
                <div id="owl-demo" class="owl-carousel owl-theme">         
                    ...
                    <div class="item" <?php if (!$fetch){?>style="display:none"<?php } ?>>
                        ...
                        <div class="wthree-news-grids">
                            <div class="col-md-4 col-xs-5 datew3-agileits">
                                <img src="admin-panel/uploads/news-one.jpg" style="height: 200px;", width="350" class="img-responsive" alt=""/>
                                </div>

                                <div class="col-md-7 col-xs-7 datew3-agileits-info ">
                                <h5 >
                                    <a href="#" data-toggle="modal" data-target="#myModal" style="color: red"><?php echo $fetch['title_one']; ?>
                    ...
                    <div class="item" <?php if (!$fetch_one){?>style="display:none"<?php } ?>>
                        <div class="">
                            ...
                            <div class="col-md-4 col-xs-5 datew3-agileits">
                                 <img src="admin-panel/uploads_two/news-two.jpg" style="height: 200px;", width="350" class="img-responsive" alt=""/>
                            </div>
                    ...
                    <div class="item" <?php if (!$fetch_two){?>style="display:none"<?php } ?>>
                        <div class="">
                            ...
                            <div class="wthree-news-grids">
                                ...
                                <div class="col-md-4 col-xs-5 datew3-agileits">
                                    <img src="admin-panel/uploads_three/news-three.jpg" style="height: 200px;", width="350" class="img-responsive" alt=""/>                
                                </div>

                                <div class="col-md-7 col-xs-7 datew3-agileits-info ">
                                    <h5><a href="#" data-toggle="modal" data-target="#myModal" style="color: red"><?php echo $fetch_two['title_three']; ?></a></h5>
                                    <h6>
	...
	<div class="services">
		...
		<div class="container">
			...
			<div class="row">
                ...
                <div class="col-md-4 agileits-w3layouts ">
                	<div class="grid1">
                       <h3><center>Wednesdays</center></h3>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Prayer</th>
                ...
                <div class="col-md-4 agileits-w3layouts">
                	<div class="grid1">
                        <h3><center>First Friday</center></h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-4 agileits-w3layouts">
                	<div class="grid1">
                       <h3><center>St.Xavier's Church-Varaganery</center></h3>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Prayer</th>
                ...
                <div class="col-md-4 agileits-w3layouts">
                	<div class="grid1">
                       <h3><center>On Every Full Moon</center></h3>
            ...
            <div class="gallery-grids">
                ...
                <div class="col-sm-4 col-xs-6 gallery-grid">
                    ...
                    <div class="grid effect-apollo"> 
                        ...
                        <a class="example-image-link" href="images/home-gallery/g1.jpg" data-lightbox="example-set" data-title="">
                ...
                <div class="col-sm-4 col-xs-6 gallery-grid">
                    <div class="grid effect-apollo"> 
                        ...
                        <a class="example-image-link" href="images/home-gallery/g2.jpg" data-lightbox="example-set" data-title="">
                ...
                <div class="col-sm-4 col-xs-6 gallery-grid">
                    <div class="grid effect-apollo"> 
                        ...
                        <a class="example-image-link" href="images/home-gallery/g4.jpg" data-lightbox="example-set" data-title="">
                ...
                <div class="col-sm-4 col-xs-6 gallery-grid">
                    <div class="grid effect-apollo"> 
                        ...
                        <a class="example-image-link" href="images/home-gallery/g5.jpg" data-lightbox="example-set" data-title="">
                ...
                <div class="col-sm-4 col-xs-6 gallery-grid">
                    <div class="grid effect-apollo"> 
                        ...
                        <a class="example-image-link" href="images/home-gallery/g6.jpg" data-lightbox="example-set" data-title="">
