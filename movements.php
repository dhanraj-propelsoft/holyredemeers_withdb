...
<body>
	...
	<div class="services">
		<h3 class="heading-agileinfo">Movements</h3>
					...
					<div class="grid-parish">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-primary"><?php echo $fetch['contact_no'];?></span></td>
                                </tr>
                        ...
                        <br>
                          ...
                          <table class="table table-striped table-bordered table-hover" >
                        	<h3> Other Activities Within the Campus </h3>
                        	<br>
                        	<thead>
                        		<tr>
                        		<th width="3%">S.No</th>
                        	...
                        	<tbody style="text-align: left">
                        		<tr>
                        		<td>1.</td>
                        		<td> Sagaya Matha Makkal Mandram</td>
                        	</tr>
                        	<tr>
                        		<td>2.</td>
                        		<td> Delphia Tailoring School</td>
                        	</tr>
                        	<tr>
                        		<td>3.</td><td> Trichy Catholic Club</td>
                        	</tr>
                        	<tr>
                        		<td>4.</td>
                        		<td>Basilica Canteen ( Only on Wednesdays)</td>
                        	</tr>
                        	<tr>
                        		<td>5.</td>
                        		<td> Basilica Book Centre (Only on Wednesdays and Sundays</td>
                        	</tr>
                        	</tbody>
