...
$select = mysqli_query($connect,"select * from parish_priest");
?>
...
<body>
	...
	<div class="services">
		<h3 class="heading-agileinfo">List of the Parish Priest</h3>
					...
					<div class="grid-parish">
                        ...
                        $i=1;
                            while($fetch = mysqli_fetch_assoc($select))
                             {
                             	$to_date_field = $fetch['to_date'];
                             	 if($fetch['to_date']=="0000-00-00"||$fetch['to_date'] == null)
                             	 	{
                             	 		$to_date_field="Now";
                             	 	}
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><span class="badge badge-primary"><?php echo $fetch['from_date'].' to '.$to_date_field; ?></span>
                                    </td>
                                </tr>
